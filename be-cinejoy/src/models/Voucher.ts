...
export type PromotionDetail = VoucherDetail | DiscountDetail | AmountDetail | ItemDetail;
...
const PromotionLineSchema = new Schema<IPromotionLine>({
    promotionType: { type: String, enum: ["item", "amount", "percent", "voucher"], required: true },
    validityPeriod: {
...
PromotionLineSchema.path("detail").validate(function (this: any, v: any) {
    ...
    if (t === "voucher") return v && (typeof v.description === "string" || v.description === undefined) && (typeof v.pointToRedeem === "number" || v.pointToRedeem === undefined) && (typeof v.quantity === "number" || v.quantity === undefined) && (typeof v.discountPercent === "number" || v.discountPercent === undefined) && (typeof v.maxDiscountValue === "number" || v.maxDiscountValue === undefined);
    if (t === "percent") return v && (v.applyType === "combo" || v.applyType === "ticket") && (typeof v.comboName === "string" || v.comboName === undefined) && (typeof v.comboDiscountPercent === "number" || v.comboDiscountPercent === undefined) && (typeof v.seatType === "string" || v.seatType === undefined) && (typeof v.ticketDiscountPercent === "number" || v.ticketDiscountPercent === undefined);
    if (t === "amount") return v && typeof v.minOrderValue === "number" && typeof v.discountValue === "number";
    if (t === "item") return v && typeof v.buyItem === "string" && typeof v.buyQuantity === "number" && typeof v.rewardItem === "string" && typeof v.rewardQuantity === "number" && ["free", "discount"].includes(v.rewardType);
    return false;
