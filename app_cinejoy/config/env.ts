...
const ENV = {
  development: {
    ...
    WEB_PAYMENT_SUCCESS_URL: "http://192.168.1.8:3000/payment/success",
    WEB_PAYMENT_CANCEL_URL: "http://192.168.1.8:3000/payment/cancel",
    WEB_BOOKING_HISTORY_URL: "http://192.168.1.8:3000/booking-history",
