...
const HomePage = () => {
  ...
  const cards: CommentCardProps[] = [
    {
      image:
        "https://res.cloudinary.com/ddia5yfia/image/upload/v1741325255/52_Robot_Hoang_Da%CC%83_acqnjy.jpg",
      ...
      users: [
        {
          name: "Đức Bùi",
          avatar:
            "https://res.cloudinary.com/ddia5yfia/image/upload/v1744014469/VTI_Cinemas/Avatar/qijumserwhbmvm7ojfbe.jpg",
          date: "07/04/2025",
          comment: "ok",
        },
        {
          name: "Tuổi Học Trò",
          avatar:
            "https://lh3.googleusercontent.com/a/ACg8ocJUnv4Vz7Q_8KrSGZlQWwTqqhHwQAsMNLkox_6NpWoji-M84V6s=s96-c",
          date: "28/03/2025",
    ...
    {
      image:
        "https://res.cloudinary.com/ddia5yfia/image/upload/v1742694536/57_Nobita_va%CC%80_Cuo%CC%A3%CC%82c_Phie%CC%82u_Lu%CC%9Bu_Va%CC%80o_The%CC%82%CC%81_Gio%CC%9B%CC%81i_Trong_Tranh_hwnm6v.webp",
      ...
      users: [
        {
          ...
          avatar:
            "https://lh3.googleusercontent.com/a/ACg8ocKYHo7paZydUjli72srSil4sXtaHC_cTZd6DE72uMptT7vSOnxdPg=s96-c",
          date: "30/03/2025",
          comment:
            "Phim cũng vui. Dẫn con đi xem, thấy con vui nên mình cũng vui theo!",
        },
      ],
    },
    {
      image:
        "https://res.cloudinary.com/ddia5yfia/image/upload/v1741325254/50_Va%CC%82y_Ha%CC%83m_Ta%CC%A3i_%C4%90a%CC%80i_Ba%CC%86%CC%81c_tzflmw.jpg",
  ...
  return (
    <>
      {/* Hero Section */}
      <div
        className={`${isDarkMode ? "bg-[#23272f]" : "bg-[#134c0f1a]"} py-16`}
      >
        <div className="container mx-auto px-40">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2 md:pr-8">
              ...
              >
                Mua vé xem phim <span className="text-[#ff6347]">Online</span>{" "}
                trên <span className="text-[#0095da]">CINEJOY</span>
              </h1>
              ...
              >
                Với nhiều ưu đãi hấp dẫn và kết nối với tất cả các rạp lớn phổ
                biến khắp Việt Nam. Đặt vé ngay tại CINEJOY!
              </p>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center">
                  ...
                  <span
                    className={`${isDarkMode ? "text-white" : "text-gray-700"}`}
                  >
                    Thỏa sức chọn chỗ ngồi, mua bắp nước tiện lợi
                  </span>
                </div>
                <div className="flex items-center">
                  <FaCheckCircle className="text-[#8b5cf6] mr-3" size={22} />
            ...
            <div className="w-full md:w-1/2 mt-10 md:mt-0">
              <div className="text-center md:text-right mb-4">
                ...
                >
                  Đặt vé xem phim trên{" "}
                  <span className={`${isDarkMode ? "text-[#0095da]" : ""}`}>
                    CINEJOY
                  </span>
                </h2>
                <p
      ...
      <div
        className={`${
          isDarkMode ? "bg-[#1e2229]" : "bg-[#cccccc2b]"
          ...
          <button
            className={`${
              isDarkMode
                ...
                : "bg-[#0f1b4c] hover:bg-blue-700 text-white"
            } px-6 py-2 rounded-full transition cursor-pointer`}
          >
            Xem tiếp nhé! ↓
          </button>
        </div>
      ...
      <div
        className={`${
          isDarkMode ? "bg-[#191b21]" : "bg-[#134c0f1a]"
        } min-h-screen py-10 px-4`}
      >
        <h1
